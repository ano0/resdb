...
L<Public Newsgroups|http://lynx.ano/.news/> (L<or if you don't have DNS|http://1.3.9.1/.news/>, NNTP is also directly accessible at 1.3.9.1)
...
L<lynx|http://lynx.ano/> (lex's wiki)
