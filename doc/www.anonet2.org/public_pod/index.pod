...
(Note: There's now L<a page|http://www.anonet2.org/anonymity> explaining
a bit about anonymity in general and its place in AnoNet in particular.)

(Note: There's now L<a darknet comparison
page|http://www.anonet2.org/darknet_comparison>), where you can compare
and contrast the various darknet options.)

(Note: There's now L<a separate page to answer all your AnoNet-related
questions|http://www.anonet2.org/faq>.)

L<A quick introduction to darknets and anonymity in general and AnoNet2
in particular, is now on a separate page.|http://www.anonet2.org/intro>
